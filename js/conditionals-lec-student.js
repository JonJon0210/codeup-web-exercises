...
var numberInput = 11;
if (numberInput > 10) {
    alert("This number is indeed greater, but not equal to 10");
}
...
var overThirteen = confirm("Are you 13 year of age or older?");
...
function trafficLight(lightHue) {
    ...
    if (lightHue === "green") {
        ...
        return "Not a traffic light color";
    }
}
...
function canYouDrive(driverAge, hasPermit) {
    if (driverAge < 15) {
        ...
        if (driverAge === 15)  {
            return "You are eligible for learners permit";
